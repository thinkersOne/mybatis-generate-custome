...
//            this.setPathInfo(this.pathInfo, template.getServiceImpl(), outputDir, "service_impl_path", "ServiceImpl");
    ...
    private void setAngularPathInfo(CustomeTemplateConfig template, String outputDir) {
        ...
        this.setPathInfo(this.pathInfo,template.getExistsNameReqTs(),outputDir,"existsNameReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getExistsNameResTs(),outputDir,"existsNameResTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetModelReqTs(),outputDir,"getModelReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetModelResTs(),outputDir,"getModelResTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetPageReqTs(),outputDir,"getPageReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetPageResTs(),outputDir,"getPageResTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetPageModelTs(),outputDir,"getPageModelTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getPageParamTs(),outputDir,"getPageParamTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetTotalReqTs(),outputDir,"getTotalReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getGetTotalResTs(),outputDir,"getTotalResTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getSaveModelTs(),outputDir,"saveModelTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getSaveReqTs(),outputDir,"saveReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getSaveResTs(),outputDir,"saveResTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getUpdateStatusReqTs(),outputDir,"updateStatusReqTs_path","ServiceModelAngular");
        this.setPathInfo(this.pathInfo,template.getUpdateStatusResTs(),outputDir,"updateStatusResTs_path","ServiceModelAngular");
