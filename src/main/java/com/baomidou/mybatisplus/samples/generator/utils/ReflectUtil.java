...
//            field.set(o, new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(fieldValue.toString()));
            field.set(o, DateUtil.dateStringFormat(fieldValue.toString()));
            ...
            String[] arr = JsonUtils.toObject(fieldValue.toString(), String[].class);
            field.set(o, arr);
        } else {
    ...
    public static Map<String,Field> getMapField(Class<?> clazz) {
        Map<String, Field> list = new HashMap();
        if(clazz == null){
            return list;
        }
        Field[] selfFields = clazz.getDeclaredFields();
        Arrays.stream(selfFields).forEach(f -> {
 ...
 /*<-------------------------辅助的私有方法----------------------------------------------->*/
    ...
    public static Object getFieldValueByName(String fieldName, Object o) throws Exception {
        ...
        value = getValueByField( o, field);
        return value;
    }

    public static Object getValueByField(Object o, Field field) throws IllegalAccessException {
        field.setAccessible(true);
        return field.get(o);
    }
